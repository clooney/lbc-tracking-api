LBC Tracking API - Java
================================
Use Java to track LBC shipments with LBC Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.lbcexpress;
    ...
    public class CreateLbcexpressTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("lbcexpress");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateLbcexpressTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetLbcexpressTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("lbcexpress");
...
Update a tracking by ID:
    ...
    public class UpdateLbcexpressTrackingExample {
